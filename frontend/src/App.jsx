...
<header className="sticky top-0 z-30 bg-white border-b border-eco-border shadow-xs">
  <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
    ...
    {/* Right Header: Tagline + Profile + Logout + Dark Mode Toggle */}
    <div className="flex items-center gap-3">
      ...
      <Link
        to="/profile"
        className="text-xs font-semibold text-eco-muted hover:text-eco-primary transition-colors px-3 py-1.5 rounded-full border border-eco-border hover:border-eco-primary/50"
      >
        Profile
      </Link>
      <button
        onClick={logout}
        className="text-xs font-semibold text-eco-muted hover:text-red-600 transition-colors px-3 py-1.5 rounded-full border border-eco-border hover:border-red-300"
      >
        Log Out
      </button>
      <DarkModeToggle />
